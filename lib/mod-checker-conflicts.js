...
module.exports.conflictMods = {
	...
	'FS19_baler_addon' : {
		...
		message  : {
			en : 'Balers of Straw Harvest can not be filled with netting/yarn, bales cannot be ejected',
		},
	},
	'FS19_RoundbalerExtension' : {
		confWith : ['FS19_addon_strawHarvest'],
		message  : {
			en : 'Versions below 1.5.0.0 will fail to work with the Straw Harvest Addon',
		},
	},
	...
	'FS19_MoreBunkersilo' : {
		confWith : ['FS19_addon_strawHarvest'],
		message  : {
			en : 'Below version 1.0.0.2 pallets cannot be sold when running the Straw Harvest addon',
		},
	},
	...
	'FS19_addon_strawHarvest' : {
		confWith : null,
		message  : {
			en : 'Straw harvest has a few notable mod non-specific incompatibilities : 1.) The palletizer will not work with autoloaded (autounloaded) trailers. 2.) Using Straw Harvest with Seasons and Maize Plus CCM will likely result in too many fill types and could convert snow to a pellet variety. 3.) Alfalfa, if on the map, cannot be baled. 4.) Strange behavior may result when using the Alpine DLC (fixed in version 1.2.1.0) 5.) If you mod folder is on OneDrive or Epic Games sync, you may be unable to sell pallets (or other odd behavior)',
		},
	},
