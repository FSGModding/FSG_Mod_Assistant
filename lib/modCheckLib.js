...
class modFileChecker {
	...
	#processModDesc() {
		...
		/* Get icon filename */
		let iconFileName = typeof parsedDesc?.iconfilename ==='string' ? parsedDesc?.iconfilename : null
		
		iconFileName ??= typeof parsedDesc?.iconfilename?.[0] ==='string' ? parsedDesc?.iconfilename[0] : null
		iconFileName = ( typeof iconFileName === 'string' && ! iconFileName.endsWith('.dds') ) ? `${iconFileName.slice(0, -4)}.dds` : iconFileName
