 ...
 * @property {modFileCollection} modCollect mod collection
 * @property {Set} modFolders mod folders as full paths
 * @property {windowLib} windowLib Window handling library
 * @property {modCacheManager} storeCache Mod Cache
 ...
 * @property {loadingWindow} loadWindow Loading window 
