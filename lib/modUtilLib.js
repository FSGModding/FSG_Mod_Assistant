...
class translator {
	...
	constructor(locale = null, debug = false) {
		...
		this.#overrideSet_Strings = new Set(Object.keys(this.specialStrings))
	...
	async getText(key) {
		...
		return this.#langPromise.then(() => {
			...
			if ( this.#overrideSet_Strings.has(entry_key) ) {
				i18nObject.entry = this.specialStrings[entry_key](i18nObject.entry)
				return i18nObject
			}
