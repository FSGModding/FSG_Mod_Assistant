...
const { saveFileChecker, saveGameManager } = require('./lib/modCheckLib.js')
...
const menu = {
	build    : (label, click, extras = {}) => menu.buildRaw(serveIPC.__(label), click, extras),
	buildRaw : (label, click, extras = {}) => {
...
const prefs = {
	...
	changeFilePath : (version, isGame = false) => {
		...
		dialog.showOpenDialog(serveIPC.windowLib.win.main, {
			...
			serveIPC.log.danger('set-game-file', 'Could not read specified file', err)
		})
	},
